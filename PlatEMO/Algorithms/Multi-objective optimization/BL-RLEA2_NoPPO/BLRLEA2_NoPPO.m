    ...
    methods
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(Population)
                ...
                % Half offspring generated by elite distribution,
                % half offspring generated by SBX + polynomial mutation
                Nelite = floor(eliteRatio*Noff);
                Nea    = Noff - Nelite;

                %% 2.1 Elite-distribution offspring without PPO
                Theta = BuildEliteTheta(Problem,Population,sigma0);

                ulElite = GenerateUpperOffspring(Theta,Problem,Nelite);
...
% Build Gaussian distribution from elite upper-level solutions.
% No PPO action is used.
